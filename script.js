...
function finishPretest() {
  let totalKnown = 0;
  for (let lvl = 1; lvl <= 5; lvl++) {
    totalKnown += levelScore[lvl];
  }

  // Logic: 15=Lvl 5, 12=Lvl 4, 9=Lvl 3, 6=Lvl 2, 3=Lvl 1
  // We'll use floor(totalKnown / 3) but cap it at 1-5
  let calculatedLevel = Math.floor(totalKnown / 3);
